                    ...
                    <div class="login-signin">
                        ...
                        <div class="card ">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    <label for="" style="float: left !important">วัน/เดือน/ปี</label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" onclick="confirm_otp()">ยืนยัน</button>
