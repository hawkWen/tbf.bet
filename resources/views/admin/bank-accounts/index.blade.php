    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container-fluid">
                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade" id="editBankAccountModal_{{ $bank_account->id }}"
                                            ...
                                            <div class="modal-dialog modal-lg" role="document">
                                                <form action="{{ route('admin.bank-account.update') }}" method="post"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <label for="">Username (SCB EASY)</label>
                                                                    <input type="text" class="form-control"
                                                                        name="username"
                                                                        value="{{ $bank_account->username }}">
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <label for="">Password (SCB EASY)</label>
                                                                    <input type="text" class="form-control"
                                                                        name="password"
                                                            ...
                                                            @if ($bank_account->bank_id == 1)
                                                                @if ($bank_account->type == 8 || $bank_account->type == 9 || $bank_account->type == 10 || $bank_account->type == 11)
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                            @php $app_id = \App\Helpers\Helper::decryptString($bank_account->app_id, 1, 'base64') @endphp
                                                                            <label for="">AppId (SCB)</label>
                                                                            <input type="password" class="form-control"
                                                                                name="app_id" value="{{ $app_id }}">
                                                                        </div>
                                                                        {{-- <div class="col-lg-6">
                                                                        @if (isset($bank_account->token))
                                                                            @php $token = \App\Helpers\Helper::decryptString($bank_account->token, 1, 'base64') @endphp
                                                                        @endif
            ...
            <div class="modal fade" id="createBankAccountModal" data-backdrop="static" tabindex="-1" role="dialog"
                aria-labelledby="staticBackdrop" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <form action="{{ route('admin.bank-account.store') }}" method="post" id="formBankAccountCreate">
                        <div class="modal-content">
