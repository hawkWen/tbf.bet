    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container-fluid">
                ...
                @foreach ($brands as $brand)
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
                                            ...
                                            <div class="my-lg-0 my-1">
                                                <a href="#"
                                                    class="btn btn-sm btn-warning font-weight-bolder text-uppercase mr-2"
                                                    data-toggle="modal"
                    ...
                    <div class="modal fade" id="editBrandModal_{{ $brand->id }}" data-backdrop="static"
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <form action="{{ route('admin.brand.update') }}" method="post" id="formUpdatebrand"
            ...
            <div class="
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <form action="{{ route('admin.brand.store') }}" method="post" id="formCreateBrand"
                        enctype="multipart/form-data">
                        <div class="modal-content">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <label for="">ถอนเงินขั้นต่ำ</label>
                                                <input type="text" class="form-control" name="withdraw_min"
                                                    input-type="money_decimal" placeholder="0.00" value="0.00">
                                            </div>
                                            <div class="col-lg-6">
                                                <label for="">ถอนอัตโนมัติในวงเงินไม่เกิน </label>
                                                <input type="text" class="form-control" name="withdraw_auto_max"
                                                    input-type="money_decimal" placeholder="10,000" value="0.00">
                                            </div>
                                        </div>
                                    </div>
                                </div>
