...
<main class="flex-shrink-0 main has-footer">
    ...
    <div class="container  text-white">
        ...
        <div class="row " id="formGeneral" style="display: none;">
            <div class="col-12 align-self-center mb-4">
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        ...
                        @if($brand->status_telephone == 1)
                            <div class="form-group float-label position-relative">
                                ...
                                <label class="form-control-label text-white"> <i class="fa fa-phone mr-2"></i> เบอร์โทรศัพท์</label>
                            </div>
                        @endif
                        @if($brand->status_line_id == 1)
                            <div class="form-group float-label position-relative">
                                ...
                                <label class="form-control-label text-white"> <i class="fab fa-line mr-2"></i> LINE ID</label>
                            </div>
                        @endif
                        <div class="form-group float-label mt-2">
    ...
    <div class="row">
        <div class="col-lg-8 mx-auto" id="btnNext">
        ...
        <div class="col-lg-8 mx-auto" id="btnRegister" style="display: none;">
...
<script>
    ...
    function submitRegister() {
        ...
        console.log(telephone, form.serializeArray());
