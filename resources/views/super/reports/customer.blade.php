    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-custom card-shadowless">
                ...
                <!--begin::Body-->
                <div class="card-body">
                    <form action="{{ route('super.report.customer') }}" method="get">
                        <div class="row">
                            <div class="col-lg-4">
                    ...
                    <form action="{{ route('super.report.customer-excel') }}" method="get">
                        ...
                        <div class="col-lg-12">
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th>แบรนด์</th>
                                        <th align="center">ลูกค้าที่สมัครและเติมเงิน/ลูกค้าที่สมัคร</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($reports as $report)
                                        <tr>
                                            ...
                                            <td align="center" class="text-success">
                                                {{ $report['customer_news'] }} / {{ $report['customers'] }}</td>
