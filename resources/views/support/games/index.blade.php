    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container-fluid">
                ...
                @foreach ($games as $game)
                    ...
                    <div class="modal fade" id="editGameModal_{{ $game->id }}" data-backdrop="static" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <form action="{{ route('support.game.update') }}" method="post" id="formUpdateGame"
                    ...
                    <div class="modal fade" id="deleteGameModal_{{ $game->id }}" data-backdrop="static"
                        ...
                        <div class="modal-dialog" role="document">
                            <form action="{{ route('support.game.delete') }}" method="post">
                                <input type="hidden" name="game_id" value="{{ $game->id }}">
                                <div class="modal-content">
            ...
            <div class="
                ...
                role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <form action="{{ route('support.game.store') }}" method="post" id="formCreateGame"
                        enctype="multipart/form-data">
                        <div class="modal-content">
