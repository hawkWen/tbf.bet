...
<head>
    <meta charset="utf-8" />
    <title>{{ env('APP_NAME') . '.' . env('APP_DOMAIN') }} | Super</title>
    <meta charset="utf-8" />
    {{-- <meta name="viewport" content="width=device-width,initial-scale=1" />
    <meta name="theme-color" content="#000000" />
    <meta name="description" content="ระบบฝาก/ถอนอัตโนมัติ" /> --}}

    @include('parts.super.css')
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled page-loading">
    ...
    <div id="kt_quick_user" class="offcanvas offcanvas-left p-10">
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="navi navi-spacer-x-0 p-0">
                ...
                <a href="{{ route('super.logout') }}" onclick="event.preventDefault();
    ...
    <div class="modal fade" id="changePasswordModal" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <form action="{{ route('super.change-password') }}" method="post" id="formChangePassword">
    ...
    @include('parts.super.javascript')
