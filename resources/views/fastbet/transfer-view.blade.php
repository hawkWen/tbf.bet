...
<main class="flex-shrink-0 pt-3 main">
    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
            ...
            @else
                <form action="{{route('fastbet.transfer.deposit', $brand->subdomain)}}" method="post" enctype="multipart/form-data" id="formDepositManual">
        ...
        <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
            <form action="{{route('fastbet.transfer.withdraw', $brand->subdomain)}}" method="post" enctype="multipart/form-data" id="formWithdrawManual">
                <input type="hidden" name="line_user_id" value="{{$customer->line_user_id}}">
                <div class="main-container" style="margin-bottom: 100px"> 
