...
<div class="content-wrapper">
    ...
    <div class="content-body">
        <form action="{{route('fastbet.member.withdraw.store',$brand->subdomain)}}" method="post" enctype="multipart/form-data" id="formWithdrawManual">
...
@section('javascript')
    ...
    <script>
        ...
        function checkCredit() {
            ...
            $.get('{{route('fastbet.member.get-credit', $brand->subdomain)}}', function(r) {
                if(r.code == 0) {
                    $.notify({
                        // options
                        message: r.message
