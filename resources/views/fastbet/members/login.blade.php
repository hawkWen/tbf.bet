                    ...
                    <form action="{{route('fastbet.member.login.store', $brand->subdomain)}}" method="post" id="formLogin">
                        <div class="card mb-0" >
                            <div class="card-body card-login">
                                ...
                                <a href="{{route('fastbet.member.register', ['brand' => $brand->subdomain, 'invite_id' => substr(str_shuffle(str_repeat($x='abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ', ceil(10/strlen($x)) )),1,10)])}}" class="btn btn-info text-dark" onclick="nextBank();"> <i class='fa fa-user-plus'></i> สมัครสมาชิก</a>
