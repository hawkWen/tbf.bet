...
<script>
    ...
    function checkAuth(profile) {
        ...
        $.post('{{route('gclub.check-auth')}}',{line_user_id: profile.userId, brand_id: brand_id}, function(r) {
    ...
    function checkBank() {
        ...
        $.post('{{route('gclub.member.check-bank')}}', {brand_id: brand_id,bank_account: bank_account, bank_id: bankId}, function(r) {
            if(r.count === false) {
