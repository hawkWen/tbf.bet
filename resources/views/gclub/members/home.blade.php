        ...
        <div class="row">
            <div class="col-lg-8 col-md-8">
                <div class="card card-congratulation-medal">
                    <div class="card-body">
                        ...
                        {{-- <a href="{{route('gclub.member.get-credit', $brand->subdomain)}}" type="button" class="btn btn-info waves-effect waves-float waves-light text-dark"> <i class="fa fa-sync"></i> รีเฟรชเครดิต</a> --}}
                        ...
                        <div class="row ">
                            <div class="col-lg-12">
                                ...
                                @elseif($brand->game_id == 5)
                                    <a href="https://fastbet98.com/#!/redirect?username={{Auth::guard('customer')->user()->username}}&password={{Auth::guard('customer')->user()->password_generate}}&url=LANDING_PAGE&hash={{$brand->hash}}" class="btn btn-info btn-block text-dark"> <i class="fa fa-gamepad"></i> เข้าเล่นเกมส์</a>
                                @endif
                            </div>
                        </div>
                    </div>
            ...
            <div class="d-lg-none">
                <div class="row ml-0 mr-0">
                    <div class="col-3">
                        <a href="{{route('gclub.member.deposit',$brand->subdomain)}}"  class="btn btn-icon btn-outline-success waves-effect img-center">
                    ...
                    <div class="col-3">
                        <a href="{{route('gclub.member.withdraw',$brand->subdomain)}}"  class="btn btn-icon btn-outline-warning waves-effect img-center">
                    ...
                    <div class="col-3">
                        <a href="{{route('gclub.member.history',$brand->subdomain)}}" class="btn btn-icon btn-outline-info waves-effect img-center">
                    ...
                    <div class="col-3">
                        <a href="{{route('gclub.member.promotion', $brand->subdomain)}}" class="btn btn-icon btn-outline-danger waves-effect img-center">
                    ...
                    <div class="col-3">
                        <a href="{{route('gclub.member.invite',$brand->subdomain)}}" class="btn btn-icon btn-outline-info waves-effect img-center">
                    ...
                    <div class="col-3">
                        <a href="{{route('gclub.member.profile',$brand->subdomain)}}" class="btn btn-icon btn-outline-danger waves-effect img-center">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <a href="{{route('gclub.member.connect-line', $brand->subdomain)}}">
