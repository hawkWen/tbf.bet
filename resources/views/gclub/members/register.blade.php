        ...
        <div class="content-body">
            <div class="auth-wrapper auth-v1 px-2">
                <div class="auth-inner py-2" >
                    ...
                    <!-- Register v1 -->
                    <form action="{{route('gclub.member.register.store', $brand->subdomain)}}" method="post" id="formCustomerCreate">
                    ...
                    <div class="text-right">
                        เป็นสมาชิกอยู่แล้ว ? 
                        <a href="{{route('gclub.member', $brand->subdomain)}}" class="" type="button">
                            เข้าสู่ระบบ
                        </a>
                    </div>
...
<script>
    ...
    function nextBank() {
        ...
        //check phone unique
        $.post('{{route('gclub.member.check-phone')}}', {telephone: telephone, brand_id: brand_id}, function(r) {
            if(r.count > 0) {
    ...
    function nextInfo() {
        ...
        $.post('{{route('gclub.member.check-bank')}}', {bank_id: bank_id,bank_account: bank_account, brand_id: brand_id}, function(r) {
            // alert(r);
            if(r.count === false) {
