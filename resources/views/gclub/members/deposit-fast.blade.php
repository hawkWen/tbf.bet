...
<div class="content-wrapper">
    ...
    <div class="content-body">
        ...
        <form action="{{route('gclub.member.deposit.fast.store', $brand->subdomain)}}" method="post" enctype="multipart/form-data" id="formDepositManual">
...
<script>
    ...
    $.post('{{route('gclub.update-promotion')}}', {customer_id: customer_id,promotion_id: promotion_id, brand_id: brand_id}, function(r) {
