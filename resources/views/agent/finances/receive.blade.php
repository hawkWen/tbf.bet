    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-custom card-shadowless">
                ...
                <!--begin::Body-->
                <div class="card-body">
                    <form action="{{ route('agent.receive') }}" method="post" id="formCreateBankAccountRequest"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label for="">จำนวนเงินที่รับ</label>
    ...
    <div class="d-flex flex-column-fluid mt-5">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-custom card-shadowless">
                ...
                <div class="card-body">
                    <form action="{{ route('agent.receive') }}" method="get">
                        <div class="row">
                            <div class="col-lg-4">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach ($bank_account_receives as $bank_account_receive)
                                <tr>
                                    <td>{{ $bank_account_receive->created_at->format('d/m/Y H:i:s') }}</td>
                                    <td>
                                        <img src="{{ asset($bank_account_receive->bankAccount->bank->logo) }}" alt=""
                                            width="25" class="mr-1">
                                        {{ $bank_account_receive->bankAccount->bank->name }}
                                        {{ $bank_account_receive->bankAccount->name }}
                                        {{ $bank_account_receive->bankAccount->account }}
                                    </td>
                                    <td align="center">
                                        {{ number_format($bank_account_receive->amount, 2) }}
                                    </td>
                                    <td>
                                        {{ $bank_account_receive->remark }}
                                    </td>
                                    <td align="center">
                                        {{ $bank_account_receive->user->name }}
                                    </td>
                                    {{-- <td width="50">

                                        <button class="btn btn-danger"
                                            onclick="deleteFnc({{ $bank_account_receive->id }})">
...
@section('javascript')
    ...
    <script>
        ...
        function deleteFnc(bank_account_receive_id) {

            if (confirm('ยืนยันการลบ ?')) {
                $.post('{{ route('agent.receive.delete') }}', {
                    bank_account_receive_id: bank_account_receive_id
                }, function() {
                    location.reload();
                });
            }
