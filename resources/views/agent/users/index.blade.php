    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container-fluid">
                                        ...
                                        <tr>
                                            ...
                                            <td width="400">
                                                ...
                                                <a href="#" data-toggle="modal"
                                                    ...
                                                    class="btn  btn-sm btn-light-warning font-weight-bolder text-uppercase py-4">แก้ไขข้อมูล</a>
                                                <a href="#" data-toggle="modal"
                                                    data-target="#changePasswordModal_{{ $user->id }}"
                                                    class="btn  btn-sm btn-warning font-weight-bolder text-uppercase py-4">แก้ไขรหัส่ผ่าน</a>
                                                <a href="#"
                                                    class="btn  btn-sm btn-danger font-weight-bolder text-uppercase py-4"
                                                    data-toggle="modal"
                                                    data-target="#deleteUserModal_{{ $user->id }}">ปิดการใช้งาน</a>
                                                <a href="{{ route('agent.user.event', ['user_id' => $user->id]) }}"
                                                    class="btn  btn-sm btn-warning font-weight-bolder text-uppercase py-4">ประวัติการทำงาน</a>


                                                <div class="modal fade" id="changePasswordModal_{{ $user->id }}"
                                                    data-backdrop="static" tabindex="-1" role="dialog"
                                                    aria-labelledby="staticBackdrop" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <form action="{{ route('agent.user.change-password') }}"
                                                            method="post" id="formUpdateUser" enctype="multipart/form-data">
                                                ...
                                                <div class="modal fade" id="editUserModal_{{ $user->id }}"
                                                    ...
                                                    aria-labelledby="staticBackdrop" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <form action="{{ route('agent.user.update') }}" method="post"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="button"
                                                                        ...
                                                                        data-dismiss="modal">ยกเลิก</button>
                                                                    <button type="button"
                                                                        class="btn btn-warning font-weight-bold">แก้ไขรหัสผ่าน</button>
                                                                    <button type="submit"
                                                                        class="btn btn-primary font-weight-bold">บันทึก</button>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="modal fade" id="deleteUserModal_{{ $user->id }}"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <form action="{{ route('agent.user.delete') }}" method="post">
                                                            <input type="hidden" name="user_id"
                                                                value="{{ $user->id }}">
                                                            <div class="modal-content">
            ...
            <div class="modal fade" id="createGameMomdal" data-backdrop="static" tabindex="-1" role="dialog"
                aria-labelledby="staticBackdrop" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <form action="{{ route('agent.user.store') }}" method="post" id="formCreateUser"
    ...
    <script>
        ...
        function resetPassword(user_id) {
            ...
            if (confirm('รหัสผ่านจะถูกรีเซ็ตเป็น Aa123123++')) {
                ...
                $.post('{{ route('agent.user.reset-password') }}', {
                    user_id: user_id
                }, function() {
                    location.reload();
                });
        ...
        function updateStatus(user_id, status) {
            ...
            $.post('{{ route('agent.user.update-status') }}', {
                user_id: user_id,
                status: status
            }, function(r) {
                location.reload();
