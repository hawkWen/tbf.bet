                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="" class="text-dark">
                                ...
                                ประวัติการทำงานของ {{ $user->name }}</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div class="card card-custom card-shadowless">
                ...
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">
                            รายงานประวัติการทำงานของ {{ $user->name }} ตั้งแต่วันที่ {{ $dates['input_start_date'] }} -
                ...
                <!--begin::Body-->
                <div class="card-body">
                    <form action="{{ route('agent.user.event', $user->id) }}" method="get">
                        <div class="row">
                            <div class="col-lg-4">
                    ...
                    <hr>
                    <form action="{{ route('agent.user.event-excel', $user->id) }}" method="get">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach ($user_events as $user_event)
                                <tr>
                                    <td width="150" align="center">{{ $user_event->created_at->format('d/m/Y H:i:s') }}
                                    </td>
