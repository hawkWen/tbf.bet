    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-custom card-shadowless">
                ...
                <!--begin::Body-->
                <div class="card-body">
                    <form action="{{ route('agent.report.event') }}" method="get">
                        <div class="row">
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-3">
                                <label for="">เลือกพนักงาน</label>
                                <select class="form-control" readonly name="user_id"
                                    value="{{ $dates['input_end_date'] }}">
                                    <option value="">เลือก</option>
                                    @foreach ($users as $user)
                                        <option value="{{ $user->id }}"
                                            @if ($user_id_select == $user->id) selected @endif>{{ $user->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-lg-2">
                    ...
                    <hr>
                    <form action="{{ route('agent.report.event-excel') }}" method="get">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach ($user_events as $user_event)
                                <tr>
                                    <td>{{ $user_event->created_at->format('d/m/Y H:i:s') }}</td>
