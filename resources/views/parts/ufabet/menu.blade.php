<div class="btn-group btn-footer" role="group" aria-label="Basic example">
    <a href="{{route('ufabet.member.deposit')}}" class="btn btn-secondary">
        <i class="fa fa-hand-holding-usd"></i>
        <span class="d-block mt-2">เติมเงิน</span>
    </a>
    <a href="{{route('ufabet.member.withdraw')}}" class="btn btn-secondary">
        <i class="fa fa-credit-card"></i>
        <span class="d-block mt-2">ถอนเงิน</span>
    </a>
    <a href="{{route('ufabet.member')}}" class="btn btn-secondary btn-home">
        <i class="fa fa-home"></i>  
        <span class="d-block mt-2">หน้าหลัก</span>
    </a>
    <a id="btnLogin" href="javascript:__doPostBack('btnLogin','')" class="btn btn-secondary">
