...
class UkingApi {
    ...
    public $url_end_point = 'https://topup-ukingbet.askmebet.io/v0.1/partner/member';
    ...
    public function loginSaGaming($data) {
        ...
        $data = [
            ...
            "password" => $data['password'],
            "isMobile" => false,
            "signature" => md5($data['username'].':'.$data['password'].':UKINGBET')
        ];
    ...
    public function winLossUsername() {

        $curl = curl_init();

        curl_setopt_array($curl, array(
            CURLOPT_URL => $this->url_end_point.'/member/winlose/'.$this->app_id.'',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
    ...
    public function winLossRef($data) {

        $curl = curl_init();

        curl_setopt_array($curl, array(
            CURLOPT_URL => $this->url_end_point.'/winLose/'.$this->app_id.'/'.$data['username'].'/'.$data['ref'],
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
