...
class RegisterController extends Controller
{
    ...
    public function index($brand) {
        ...
        return view('fastbet.register', \compact('brand','banks'));
    ...
    public function store(Request $request) {
        ...
        // $customers = Customer::where('bank_account_scb','=', $data['bank_account_scb'])->first();

        // if($customers) {

        //     return redirect()->back()->withErrors(['เลขที่บัญชีธนาคารซ้ำ กรุณาติดต่อพนักงาน']);
