...
class WithdrawController extends Controller
{
    ...
    public function index($brand) {
        ...
        return view('fastbet.members.withdraw',\compact('brand','customer','bank_accounts'));
    ...
    public function store(Request $request) {
        ...
        if($response_withdraw['status'] === false) {
            ...
            return redirect()->back()->withErrors(['เครดิตไม่พอคุณมี เครดิตคงเหลือ '. $credit['data']['credit']]);
            // return redirect()->back()->withErrors(['เครดิตไม่พอคุณมี เครดิตคงเหลือ ']);
