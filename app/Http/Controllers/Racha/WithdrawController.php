...
class WithdrawController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        // $response_withdraw = json_decode(file_get_contents($brand->server_api.'/server-api/gclub/?withdraw&username='.$brand->agent_username.'&password='.$brand->agent_password.'&user='.$customer->username.'&amount='.$input['amount']),true);
