...
class DepositController extends Controller
{
    ...
    public function index($brand) {
        ...
        if($brand->type_deposit == 1) {
            return view('gclub.members.deposit', compact('customer','brand','bank_accounts','promotions','bank_account_reserves'));
        } else {
            return view('gclub.members.deposit-fast', compact('customer','brand','bank_accounts','promotions','bank_account_reserves'));
        }
