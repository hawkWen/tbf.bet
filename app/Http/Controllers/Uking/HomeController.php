...
class HomeController extends Controller
{
    public function index($brand) {
        ...
        if($customer->line_menu_member === null) {

            Bot::loginSaGame($brand,$customer);
        ...
        if($customer->username) {
            ...
            $response = Bot::creditUking($brand,$customer);

        } 

        return view('uking.members.home',\compact('brand','promotions'));
    ...
    public function history($brand) {
        ...
        return view('uking.members.history', compact('customer','brand','histories'));
    ...
    public function promotion($brand) {
        ...
        return view('uking.members.promotion', compact('promotions','brand'));
    ...
    public function invite($brand) {
        ...
        return view('uking.members.invite',compact('brand','customer','customer_invites','promotion','promotion_cost_last','customer_invite_bonus'));
    ...
    public function connect($brand) {
        ...
        return view('uking.members.connect',compact('brand'));
