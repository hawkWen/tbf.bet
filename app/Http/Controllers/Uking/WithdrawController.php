...
class WithdrawController extends Controller
{
    ...
    public function index($brand) {
        ...
        return view('uking.members.withdraw',\compact('brand','customer','bank_accounts'));
    ...
    public function store(Request $request) {
        ...
        $response_credit = Bot::creditUking($brand,$customer);
        ...
        // $response_withdraw = Bot::withdrawuking($brand,$customer,$input['amount']);

        // $response_withdraw = json_decode(file_get_contents($brand->server_api.'/server-api/uking/?withdraw&username='.$brand->agent_username.'&password='.$brand->agent_password.'&user='.$customer->username.'&amount='.$input['amount']),true);
